...
const Living = () => {
  return (
    <div className="md:mt-16 ">
        ...
        <div >
            <h1 className="text-6xl font-semibold text-center">LIVING SOLUTION</h1>
            <hr className="w-11/12 mx-auto"></hr>
         
        </div>
        <div className="flex flex-col items-center justify-center">
                 <p className='text-xl italic text-center'>Find out how to transform a home, to be  lived in</p>
            <p className="text-lg italic mx-auto px-4 text-center">The modular program has been designed to integrate patented transformable systems and for specific 
             functions. The versatility of the products, with high technological content, which with simple gestures can be 
             transformed into day and night versions.</p>
            </div>
      ...
      <Carousel.Item interval={500}>
        <img
          className="md:h-96  w-full" style={{height:'600px'}}
          src="https://source.unsplash.com/random/?productivity,space"
          alt="Second slide"
        />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        ...
        <div className="flex flex-col justify-center  items-center md:w-3/4 mt-4  gap-3 mx-auto">
            <h3 className>Living Environments</h3>
        ...
        <div className=' mt-3 '>
            <div className='flex gap-4 md:flex-row flex-col'>
               <img src='https://picsum.photos/650/350' className=' shadow-md shadow-gray-600' alt='...'style={{width:'550px',height:'400px'}} />
                ...
                <h3 className='border-b-2 ml-3 text-4xl border-black' style={{color:'#37978B',borderBottom:'2px solid #37978B'}}>Environments 1</h3>
